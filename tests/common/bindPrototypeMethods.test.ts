...
describe("bindPrototypeMethods", () => {
	it("binds prototype methods to the instance", () => {
		...
		DCommon.bindPrototypeMethods(counter);
	...
	it("binds inherited methods while keeping the closest override", () => {
		class Parent {
			public value = "parent";
		...
		DCommon.bindPrototypeMethods(child);
	...
	it("ignores accessors and non-writable methods", () => {
		class Service {
			public value = "value";
		...
		DCommon.bindPrototypeMethods(service);
